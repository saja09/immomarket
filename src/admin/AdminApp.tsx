...
function Dashboard({
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Dashboard"
        subtitle="رؤية مضغوطة ومريحة للإحصائيات والنتائج"
      />
      ...
      <div className="grid gap-4 xl:grid-cols-[1.4fr_1fr]">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-[20px] bg-white p-4 shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            ...
            {latest.length === 0 ? (
              <p className="text-right text-[12px] font-bold text-slate-500">
                مازال ما كاين حتى عقار.
              </p>
            ) : (
              <div className="space-y-2">
                {latest.map((property) => (
                  <div
                    key={property.id}
                    className="rounded-[16px] bg-slate-50 px-4 py-3 text-right"
                  >
            ...
            <div>
              ...
              <div className="grid gap-3">
                <div>
                  ...
                  <Input value={image} onChange={setImage} placeholder="رابط الصورة الرئيسية" />
                </div>

                <div>
                  <FieldLabel>صور gallery (كل رابط في سطر)</FieldLabel>
                  <textarea
                    value={galleryText}
                ...
                <div>
                  ...
                  <Input value={video} onChange={setVideo} placeholder="رابط الفيديو إن وجد" />
                </div>
              </div>
            </div>
        ...
        <div className="space-y-4">
          <InfoBox
            ...
            items={[
              ...
              "الصور والفيديو والموقع واجدين من دابا",
            ]}
          />
          ...
          <div className="rounded-[20px] bg-white p-4 text-right shadow-[0_10px_24px_rgba(15,23,42,0.04)]">
            ...
            <div className="mt-3 rounded-[18px] border border-slate-200 bg-slate-50 p-4">
              ...
              <p className="mt-3 text-[18px] font-black text-[#2563eb]">
                {formatDh(finalPrice)}
              </p>
              <p className="mt-1 text-[12px] font-bold text-slate-500">
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        ...
        subtitle="تحكم كامل في العقارات المضافة"
      />
          ...
          <div className="space-y-3">
            {properties.map((property) => {
              ...
              return (
                <div
                  key={property.id}
                  className="rounded-[18px] border border-slate-200 bg-[#fcfcfd] p-4"
                >
...
export default function AdminApp() {
  const [isAdmin, setIsAdmin] = useState(
    localStorage.getItem("immomarket_admin") === "true"
  )
      ...
      case "visits":
        return (
          <PlaceholderPage
            ...
            itemsRight={[
              "معرفة شكون زار فعلاً",
              "معرفة شنو المصدر اللي كيجيب زيارة",
              "تقييم جودة المتابعة",
            ]}
          />
        )
      ...
      case "sold":
        return (
          <PlaceholderPage
            ...
            itemsRight={[
              "الاحتفاظ بتاريخ البيع",
              "تحليل النتائج السابقة",
              "الرجوع للبيانات عند الحاجة",
            ]}
          />
        )
